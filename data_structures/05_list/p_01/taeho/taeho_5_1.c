...
int main() {
    List l1;
    l1.header=(Node*)malloc(sizeof(Node));
    if (l1.header==NULL) {
    ...
    List l2;
    l2.header=(Node*)malloc(sizeof(Node));
    if (l2.header==NULL) {
...
List sum(List *l1,List *l2) {
    ...
    result.header->coef=0;
    result.header->exp=0;
    result.header->next=NULL;
    Node *trail_node=result.header;
    Node *l1_pointer=l1->header->next;
    Node *l2_pointer=l2->header->next;
